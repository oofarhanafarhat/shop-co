...
export default function Footer() {
    return (
      <footer className=" w-screen  min-h-screen lg:w-[1440px] lg:h-[450px] bg-[#F0F0F0] justify-center items-center ">
        <div>
          <div className="lg:w-[1240] lg:h-[180px] bg-[#000000] text-[#FFFFFF]  text-center md:text-left md:flex lg:items-center lg:justify-between items-center rounded-3xl mx-10 ">
        ...
        <div className="lg:w-[1440px] mx-auto px-4 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2 text-gray-700">
          <div className="">
            <h3 className="font-extrabold text-2xl text-[#383030] ">SHOP.CO</h3>
            <p className="mt-2 text-sm w-[200px] h-[40px]">
            We have clothes that suits your style and which you’re proud to wear. From women to men.
            </p>
            <div className="flex space-x-4  pt-5">
                <Image src={"/v05.png"}  width={14} height={12} alt="" className="rounded-full bg-gray-100"/>
                <Image src={"/fb.png"}  width={18} height={16} alt="" className="bg-[#000000] rounded-full"/>
                <Image src={"/insta.png"}  width={18} height={16} alt="" className=" bg-gray-100 rounded-full"/>
                <Image src={"/git.png"}  width={16} height={16} alt="" className="rounded-full bg-gray-100"/>
